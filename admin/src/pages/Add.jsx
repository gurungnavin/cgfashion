  ...
  return (
    <form className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <textarea className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='write here' required />
      </div>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input className='w-full px-2 py-2 sm:w-[120px]' type="Number" placeholder='150 円'/>
        </div>
      </div>
